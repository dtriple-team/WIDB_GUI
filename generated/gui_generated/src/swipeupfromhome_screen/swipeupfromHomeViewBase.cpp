...
swipeupfromHomeViewBase::swipeupfromHomeViewBase() :
    buttonCallback(this, &swipeupfromHomeViewBase::buttonCallbackHandler)
{
...
void swipeupfromHomeViewBase::setupScreen()
{

}

void swipeupfromHomeViewBase::buttonCallbackHandler(const touchgfx::AbstractButton& src)
{
    if (&src == &button1)
    {
        //movetoSetting
